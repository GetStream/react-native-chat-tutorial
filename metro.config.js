...
const moduleBlacklist = [
    ...
    new RegExp(repoDir + '/stream-chat-react-native/examples/NativeMessaging/.*'),
    new RegExp(repoDir + '/stream-chat-react-native/examples/SampleApp/.*'),
    new RegExp(repoDir + '/stream-chat-react-native/examples/TypeScriptMessaging/.*'),
    new RegExp(repoDir + '/stream-chat-react-native/native-package/node_modules/.*'),
